  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full sm:w-auto px-10 py-3 rounded-2xl cursor-pointer font-semibold flex items-center justify-center gap-2 transition shadow 
          ${
            loading || !text.trim()
      ...
      <p className="text-sm text-gray-500">
        Tip: Longer articles provide more accurate results with better
        explainability.
      </p>
    </motion.div>
  );
